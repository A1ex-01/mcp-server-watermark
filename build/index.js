...
const defaultInputPath = "/Users/a1ex/Desktop/mcp-server/mcp-server-watermark/src/assets/test.pdf";
const defaultOutputPath = "/Users/a1ex/Desktop/mcp-server/mcp-server-watermark/src/assets/test-watermark.pdf";
...
server.tool("watermark", "给PDF文件添加水印", { input: WatermarkPdfArgumentsSchema }, async (input) => {
    try {
        //给路径文件打水印
        const { input: { inputPath, outputPath, watermarkText }, } = input;
        // 转换为绝对路径
